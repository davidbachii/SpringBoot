...
INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Cadena Perpetua', 'La historia de un hombre inocente encarcelado que encuentra esperanza y amistad en Shawshank.',  'Shawshank Redemption', 'Drama', 'Estados Unidos', 142, 1994, 'Columbia Pictures', 'Frank Darabont', 15, 'Basada en la novela de Stephen King.', 'Tim Robbins, Morgan Freeman', 'images/CadenaPerpetua.jpeg', 'https://www.youtube.com/embed/4u87tmlj4oE?si=n318897_-rDPVLzP', 9.3, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('El Caballero Oscuro', 'Batman se enfrenta a su némesis, el Joker, en un juego de ingenio que amenaza Gotham City.', 'The Dark Knight', 'Accion, Crimen, Drama', 'Estados Unidos', 152, 2008, 'Warner Bros.', 'Christopher Nolan', 16, 'Ganadora de 2 premios Oscar.', 'Christian Bale, Heath Ledger, Aaron Eckhart', 'images/CaballeroOscuro.jpeg', 'https://www.youtube.com/embed/9MEuGQtM9wA?si=A5YSZGVuwDCtK83o', 9.0, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Cars', 'En un mundo donde los autos son seres vivos, el aspirante a corredor Rayo McQueen termina en un pequeño pueblo llamado Radiador Springs. Aprendiendo lecciones valiosas de amistad y humildad, Rayo descubre el verdadero significado de la velocidad.', 'Cars', 'Animacion', 'Estadounidense', 120, 2006, 'Pixar', 'John Lasseter', 3, 'Datos adicionales sobre la película Cars.', 'Owen Wilson, Bonnie Hunt', 'images/Cars.png', 'https://www.youtube.com/embed/nuQDFYpPUh4?si=owxKwSIVF6QzUeh1', 7.1, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Cars 2', 'Rayo McQueen y su amigo Mate se ven envueltos en una misión internacional de espionaje cuando son reclutados para participar en el Grand Prix Mundial. Intrigas, giros y vueltas esperan a nuestros héroes mientras luchan contra una misteriosa amenaza.', 'Cars 2', 'Animacion', 'Estadounidense', 130, 2011, 'Pixar', 'John Lasseter', 3, 'Datos adicionales sobre la película Cars 2.', 'Owen Wilson, Larry the Cable Guy', 'images/Cars2.png', 'https://www.youtube.com/embed/oGpIMRq1O3k?si=UUSOoOjMZg_RPptk', 6.2, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Cars 3', 'Con una nueva generación de corredores amenazando su posición, Rayo McQueen se embarca en un emocionante viaje de redescubrimiento y superación. Con la ayuda de entrenadores y nuevos amigos, Rayo intenta volver al ruedo y dejar su marca.', 'Cars 3', 'Animacion', 'Estadounidense', 110, 2017, 'Pixar', 'Brian Fee', 3, 'Datos adicionales sobre la película Cars 3.', 'Owen Wilson, Cristela Alonzo', 'images/Cars3.png', 'https://www.youtube.com/embed/wtmW9rSRIzU?si=MttED7g2UgQk5A08', 6.5, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Kung Fu Panda', 'Po, un torpe oso panda, sueña con convertirse en un hábil guerrero de kung fu. Su vida da un giro cuando es elegido accidentalmente para cumplir una antigua profecía. Po se embarca en una aventura cómica y emocionante para aprender las artes marciales y salvar el Valle de la Paz.',  'Kung Fu Panda', 'Animacion', 'Estadounidense', 95, 2008, 'DreamWorks Animation', 'Mark Osborne, John Stevenson', 3, 'Datos adicionales sobre la película Kung Fu Panda.', 'Jack Black, Angelina Jolie', 'images/KunfuPanda.png', 'https://www.youtube.com/embed/vRhMIpFu-Zw?si=Hwgor3iZaTcqtmz4', 8.0, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('One Piece', 'Monkey D. Luffy y su valiente tripulación emprenden un viaje épico en busca del legendario tesoro conocido como "One Piece". Enfrentándose a peligros, enemigos y desafíos, Luffy se esfuerza por convertirse en el Rey de los Piratas.', 'One Piece', 'Animacion', 'Japonesa', 120, 2022, 'Toei Animation', 'Eiichiro Oda', 12, 'Datos adicionales sobre la película One Piece.', 'Mayumi Tanaka, Kazuya Nakai', 'images/OnePiece.png', 'https://www.youtube.com/embed/CWrJQzm0diI?si=tzF0AIbtEib0kGCV', 8.5, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Rocky', 'Rocky Balboa, un boxeador de Filadelfia con pocas oportunidades, recibe la oportunidad de enfrentarse al campeón de peso pesado Apollo Creed. Aunque inicialmente es considerado como un oponente fácil, Rocky se prepara para la pelea de su vida, demostrando coraje y determinación.',  'Rocky', 'Drama', 'Estadounidense', 120, 1976, 'United Artists', 'John G. Avildsen', 12, 'Datos adicionales sobre la película Rocky.', 'Sylvester Stallone, Talia Shire, Burgess Meredith', 'images/Rocky.png', 'https://www.youtube.com/embed/Vb-Bx2YkIPA?si=UZigoaMfxKRR6Hy8', 8.1, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Harry Potter y la Piedra Filosofal', 'Harry Potter, un niño huérfano, descubre que es un mago y comienza su educación en la escuela de magia de Hogwarts. Junto a sus amigos, enfrenta misterios y descubre la verdad sobre su pasado.', 'Harry Potter and the Philosophers Stone', 'Aventura, Familia, Fantasia', 'Reino Unido', 152, 2001, 'Warner Bros.', 'Chris Columbus', 7, 'Basada en la novela de J.K. Rowling.', 'Daniel Radcliffe, Emma Watson, Rupert Grint', 'images/potter.png', 'https://www.youtube.com/embed/VyHV0BRtdxo?si=3DCTwOj-S_GY1s_X', 8.7, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Matrix', 'Neo, un hacker, descubre que vive en un simulacro y se une a una rebelión contra las máquinas que controlan la realidad. Una historia de ciencia ficcion llena de acción y reflexión filosófica.',  'The Matrix', 'Accion, Ciencia Ficcion', 'Estados Unidos', 136, 1999, 'Warner Bros.', 'Lana Wachowski, Lilly Wachowski', 15, 'Ganadora de 4 premios Oscar.', 'Keanu Reeves, Laurence Fishburne, Carrie-Anne Moss', 'images/Matrix.png', 'https://www.youtube.com/embed/m8e-FF8MsqU?si=LKyR-3B4Q2qFD0Js', 8.7, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Jurassic Park', 'Un parque temático con dinosaurios creados mediante ingeniería genética se convierte en una pesadilla cuando los animales escapan y amenazan a los visitantes. Una aventura llena de suspense y emoción.', 'Jurassic Park', 'Aventura, Ciencia Ficcion', 'Estados Unidos', 127, 1993, 'Universal Pictures', 'Steven Spielberg', 12, 'Basada en la novela de Michael Crichton.', 'Sam Neill, Laura Dern, Jeff Goldblum', 'images/JurassicPark.jpg', 'https://www.youtube.com/embed/lc0UehYemQA?si=UqjSjLRnQ4S4izZk', 8.4, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Titanic', 'La historia de amor entre Jack y Rose se desarrolla a bordo del Titanic, el famoso transatlántico que choca con un iceberg y enfrenta un trágico destino. Una épica romántica y dramática.',  'Titanic', 'Drama, Romance', 'Estados Unidos', 195, 1997, '20th Century Fox', 'James Cameron', 12, 'Ganadora de 11 premios Oscar.', 'Leonardo DiCaprio, Kate Winslet', 'images/Titanic.jpg', 'https://www.youtube.com/embed/2e-eXJ6HgkQ?si=IctQRBQoTeKUh86p', 8.8, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Forrest Gump', 'Forrest Gump, un hombre con un coeficiente intelectual bajo, vive una vida extraordinaria llena de aventuras, amor y acontecimientos históricos.', 'Forrest Gump', 'Drama, Romance', 'Estados Unidos', 142, 1994, 'Paramount Pictures', 'Robert Zemeckis', 12, 'Basada en la novela de Winston Groom.', 'Tom Hanks, Robin Wright, Gary Sinise', 'images/ForrestGump.jpg', 'https://www.youtube.com/embed/uPIEn0M8su0?si=fLm5qE9BQMWXx6oS', 7.7, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('Interestelar', 'Un equipo de astronautas se embarca en un viaje a través de un agujero de gusano en busca de un nuevo hogar para la humanidad. Una odisea espacial llena de misterio y descubrimiento.', 'Interstellar', 'Aventura, Drama, Ciencia Ficcion', 'Estados Unidos', 169, 2014, 'Paramount Pictures', 'Christopher Nolan', 12, 'Ganadora del premio Oscar a los mejores efectos visuales.', 'Matthew McConaughey, Anne Hathaway, Jessica Chastain', 'images/Interstellar.jpg', 'https://www.youtube.com/embed/zSWdZVtXT7E?si=4r2XsH2dSsO-0KKp', 8.4, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('El Rey León', 'Simba, un joven león, lucha por reclamar su lugar como rey después de que su malvado tío Scar usurpe el trono de su padre. Una épica historia de crecimiento, amor y responsabilidad.', 'The Lion King', 'Animacion, Aventura, Drama', 'Estados Unidos', 118, 1994, 'Walt Disney Pictures', 'Roger Allers, Rob Minkoff', 3, 'Inspirada en Hamlet de William Shakespeare.', 'Matthew Broderick, Jeremy Irons, James Earl Jones', 'images/LionKing.jpg', 'https://www.youtube.com/embed/4sj1MT05lAA?si=yBQKcF9tQoq6zF3a', 6.9, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion,  titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('El Señor de los Anillos: La Comunidad del Anillo', 'Frodo Bolsón, un hobbit tranquilo, se embarca en una aventura épica para destruir un anillo maligno y salvar a la Tierra Media del mal. Una saga de fantasía que redefine el género.',  'The Lord of the Rings: The Fellowship of the Ring', 'Aventura, Drama, Fantasia', 'Estados Unidos', 178, 2001, 'New Line Cinema', 'Peter Jackson', 12, 'Basada en la novela de J.R.R. Tolkien.', 'Elijah Wood, Ian McKellen, Viggo Mortensen', 'images/LOTR1.jpg', 'https://www.youtube.com/embed/V75dMMIW2B4?si=OzZkPOklRZWaTpvl', 8.3, 'pelicula');

INSERT INTO Pelicula (nombre_contenido, descripcion, titulo_original, genero, nacionalidad, duracion, anho, distribuidora, director, clasificacion_edad, otros_datos, actores, url_image, url_video, calificacion, tipo)
VALUES ('El Silencio de los Inocentes', 'Un joven agente del FBI busca la ayuda de Hannibal Lecter, un brillante pero peligroso psiquiatra encarcelado, para atrapar a un asesino en serie. Un thriller psicológico que te mantendrá al borde de tu asiento.',  'The Silence of the Lambs', 'Crimen, Drama, Thriller', 'Estados Unidos', 118, 1991, 'Orion Pictures', 'Jonathan Demme', 18, 'Basada en la novela de Thomas Harris.', 'Jodie Foster, Anthony Hopkins, Scott Glenn', 'images/SilenceoftheLambs.jpg', 'https://www.youtube.com/embed/W6Mm8Sbe__o?si=tT_TQOD3RfG2V2tJ', 7.2, 'pelicula');
